...
public class LeafContract {
    ...
    public static final class CatalogItem  {
        ...
        public static final String TABLE_NAME = "CatalogItem_table";
    ...
    public static final class CatalogItemModifier {
        private CatalogItemModifier() {}

        public static final String TABLE_NAME = "CatalogItemModifier_table";
    ...
    public static final String[] ALLTABLES = new String[] {
        CatalogItem.TABLE_NAME,
        CatalogItemModifier.TABLE_NAME,
        Order.RESOURCE_NAME,
        Printer.RESOURCE_NAME,
